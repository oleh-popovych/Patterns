...
abstract class NftProvider {
    public abstract getAsset(contract: string, tokenId: string): Asset

    public abstract showAsset(contract: string, tokenId: string): string
}

class OpenseaAsset implements Asset {
    private assetData
...
class MoralisAsset implements Asset {
    private assetData
...
class OpenseaProvider extends NftProvider {
    public getAsset(contract: string, tokenId: string): Asset {
